...
#if defined(__SSE2__) && (defined(__APPLE__) || defined(__clang__))
#include <emmintrin.h> // SSE2 intrinsics for macOS/Clang compatibility
#endif
...
// Conditional compilation for andn operations
#if defined(__APPLE__) || defined(__clang__)
#define vec_andn(x, y) ((v2di)_mm_andnot_si128((x), (y)))
#else
...
// Conditional compilation for shift operations
#if defined(__APPLE__) || defined(__clang__)
#define v16_shift_l(x, c) ((v16)_mm_slli_epi16(x, c))
#define v16_shift_r(x, c) ((v16)_mm_srai_epi16(x, c))
#define v16_cmp(a, b) ((v16)_mm_cmpgt_epi16(a, b))
#else
#define v16_shift_l(x, c) ((x) << (c))
#define v16_shift_r(x, c) ((x) >> (c))
#define v16_cmp(a, b) ((a) > (b))
#endif

// Conditional compilation for interleave and merge operations
#if defined(__APPLE__) || defined(__clang__)
#define v16_interleavel(a, b) ((v16)_mm_unpacklo_epi16(a, b))
#define v16_interleaveh(a, b) ((v16)_mm_unpackhi_epi16(a, b))

#define v16_mergel(a, b) V1632(_mm_unpacklo_epi16(a, b))
#define v16_mergeh(a, b) V1632(_mm_unpackhi_epi16(a, b))

#define v8_mergel(a, b) V816(_mm_unpacklo_epi8(a, b))
#define v8_mergeh(a, b) V816(_mm_unpackhi_epi8(a, b))
#else
#define v16_interleavel(a, b) __builtin_ia32_punpcklwd128(a, b)
#define v16_interleaveh(a, b) __builtin_ia32_punpckhwd128(a, b)
...
// Conditional compilation for v32 shift and shuffle operations
#if defined(__APPLE__) || defined(__clang__)
#define v32_shift_l(x, c) _mm_slli_epi32(x, c)
#define v32_shift_r(x, c) _mm_srli_epi32(x, c)
#define v32_shuf(x, mask) _mm_shuffle_epi32(x, mask)
#else
...
#define v16_shift_l(x, c) v128_sl16(x, c)
#define v16_shift_r(x, c) v128_sr16(x, c)
#define v16_cmp(x, y) v128_cmpgt16(x, y)
