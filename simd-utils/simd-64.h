...
// Rotate right by c bytes - wrapper to handle compile-time constant requirement
static inline v64_t v64_shuflr_x8(__m64 v, const int c)
{
   switch (c)
   {
   case 0:
      return _mm_alignr_pi8(v, v, 0);
   case 1:
      return _mm_alignr_pi8(v, v, 1);
   case 2:
      return _mm_alignr_pi8(v, v, 2);
   case 3:
      return _mm_alignr_pi8(v, v, 3);
   case 4:
      return _mm_alignr_pi8(v, v, 4);
   case 5:
      return _mm_alignr_pi8(v, v, 5);
   case 6:
      return _mm_alignr_pi8(v, v, 6);
   case 7:
      return _mm_alignr_pi8(v, v, 7);
   default:
      return v; // fallback for invalid values
   }
}
