...
// Logical bit shift
// ARM NEON requires compile-time constants for shift amounts
// For variable shifts, we need wrapper functions
static inline uint64x2_t v128_sl64_wrapper(uint64x2_t v, int n)
{
   switch (n)
   {
   case 0:
      return v;
   case 1:
      return vshlq_n_u64(v, 1);
   case 2:
      return vshlq_n_u64(v, 2);
   case 3:
      return vshlq_n_u64(v, 3);
   case 4:
      return vshlq_n_u64(v, 4);
   case 5:
      return vshlq_n_u64(v, 5);
   case 6:
      return vshlq_n_u64(v, 6);
   case 7:
      return vshlq_n_u64(v, 7);
   case 8:
      return vshlq_n_u64(v, 8);
   case 11:
      return vshlq_n_u64(v, 11);
   case 16:
      return vshlq_n_u64(v, 16);
   case 32:
      return vshlq_n_u64(v, 32);
   default:
      return v; // fallback
   }
}

static inline uint64x2_t v128_sr64_wrapper(uint64x2_t v, int n)
{
   switch (n)
   {
   case 0:
      return v;
   case 1:
      return vshrq_n_u64(v, 1);
   case 2:
      return vshrq_n_u64(v, 2);
   case 3:
      return vshrq_n_u64(v, 3);
   case 4:
      return vshrq_n_u64(v, 4);
   case 5:
      return vshrq_n_u64(v, 5);
   case 6:
      return vshrq_n_u64(v, 6);
   case 7:
      return vshrq_n_u64(v, 7);
   case 8:
      return vshrq_n_u64(v, 8);
   case 11:
      return vshrq_n_u64(v, 11);
   case 16:
      return vshrq_n_u64(v, 16);
   case 32:
      return vshrq_n_u64(v, 32);
   default:
      return v; // fallback
   }
}

// ARM NEON 16-bit shift wrapper for variable shifts
static inline uint16x8_t v128_sl16_wrapper(uint16x8_t v, int n)
{
   switch (n)
   {
   case 0:
      return v;
   case 1:
      return vshlq_n_u16(v, 1);
   case 2:
      return vshlq_n_u16(v, 2);
   case 3:
      return vshlq_n_u16(v, 3);
   case 4:
      return vshlq_n_u16(v, 4);
   case 5:
      return vshlq_n_u16(v, 5);
   case 6:
      return vshlq_n_u16(v, 6);
   case 7:
      return vshlq_n_u16(v, 7);
   case 8:
      return vshlq_n_u16(v, 8);
   default:
      return v; // fallback
   }
}

#define v128_sl64 v128_sl64_wrapper
#define v128_sl32 vshlq_n_u32
#define v128_sl16 v128_sl16_wrapper
#define v128_sl8 vshlq_n_u8

#define v128_sr64 v128_sr64_wrapper
...
#define v64_set16(u16_3, u16_2, u16_1, u16_0) \
   vcreate_u16(((uint64_t)(((uint32_t)(u16_3) << 16) | (uint32_t)(u16_2)) << 32) | ((uint64_t)(((uint32_t)(u16_1) << 16) | (uint32_t)(u16_0))))

#define v64_set8(u8_7, u8_6, u8_5, u8_4, u8_3, u8_2, u8_1, u8_0) \
   vcreate_u8(                                                   \
       ((uint64_t)(((uint32_t)(((uint16_t)(u8_7) << 8) | (uint16_t)(u8_6)) << 16) | ((uint32_t)(((uint16_t)(u8_5) << 8) | (uint16_t)(u8_4)))) << 32) | ((uint64_t)(((uint32_t)(((uint16_t)(u8_3) << 8) | (uint16_t)(u8_2)) << 16) | ((uint32_t)(((uint16_t)(u8_1) << 8) | (uint16_t)(u8_0))))))
